...
public class QBaseTimeEntity extends EntityPathBase<BaseTimeEntity> {
    ...
    private static final long serialVersionUID = 18953026L;
    ...
    public final DateTimePath<java.time.LocalDateTime> updatedTimeStamp = createDateTime("updatedTimeStamp", java.time.LocalDateTime.class);
